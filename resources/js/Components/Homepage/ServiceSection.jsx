            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-12 2xl:grid-cols-12 gap-8 py-10">
                    {categories.map((item, index) => {
                        return <div key={index} className="group col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-4 xl:col-span-3 2xl:col-span-3 border-2 border-gray-200 hover:border-blue-200 hover:shadow-blue-100 hover:scale-105 hover:transition-all duration-700 rounded-md shadow-lg ">
