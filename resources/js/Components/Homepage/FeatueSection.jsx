            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-2  gap-6">

                {
                    features.map((feature, index) => {
                        return <div key={index} className="group md:flex flex items-start  gap-y-5 size-full space-x-4 bg-gray-50 focus:outline-none focus:bg-gray-100 dark:bg-slate-800 rounded-lg p-3 dark:hover:bg-slate-900 dark:focus:bg-neutral-800 border-2 hover:scale-105  dark:border-gray-700 transition-all">
