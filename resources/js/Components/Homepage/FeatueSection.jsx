            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-2 items-center gap-6">

                {
                    features.map((feature, index) => {
                        return <div key={index} className="group flex items-center gap-y-6 size-full space-x-5 bg-gray-50 focus:outline-none focus:bg-gray-100 rounded-lg p-3 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 border hover:scale-105 transition-all">
