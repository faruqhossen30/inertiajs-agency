        ...
        <div className="col-span-6 md:col-span-4">
            <a class="flex flex-col group bg-white border shadow-sm rounded-md overflow-hidden hover:shadow-lg transition dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]" href="#">
                <div class=" overflow-hidden">
                    <img class="w-full object-fill group-hover:scale-105 transition-transform duration-500 ease-in-out" src="./marketing.png" alt="Image Description" />
                </div>
                <div class="text-center">
                    <h3 class="text-lg font-bold text-gray-800 dark:text-gray-400 py-3">
                    ...
                    <div className="text-center">
                        ...
                        <p class="text-sm py-2 text-gray-800 dark:text-gray-400">
                            <span class="font-bold">4.6</span> /5 - from 12k reviews
                        </p>
                    </div>

                </div>
                <div class="flex items-center justify-between p-3 border-t sm:px-5 dark:border-gray-700">
