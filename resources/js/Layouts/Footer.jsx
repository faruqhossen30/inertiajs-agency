...
export default function Footer({ auth }) {
    return (
        <>
            ...
            <section className="w-full border-t dark:border-t-gray-700 bg-gray-950">
                <footer className="hidden container lg:block py-5 px-4 sm:px-6 lg:px-8 mx-auto">
                    ...
                    <div className="grid grid-cols-12 py-16">
                        <div className="col-span-3">
                            <div className=" space-y-6">
                                <div className=" flex items-center space-x-3 text-sm">
                                    <img className='h-6' src={window.location.origin + '/fc0cd06a-0b05-4ced-af75-7fcc74579754.jpeg'} alt="" srcset="" />
                                    <h1 className=' text-white capitalize font-bold text-xl'>pstls.</h1>
                                </div>

                                <p className='text-sm text-white leading-7'>Lorem ipsum dolor, sit amet<br /> consectetur adipisicing   quis.</p>
                                <div className="flex space-x-2">
                                    <svg className="w-6 h-6 text-gray-50 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="col-span-3">
                            <h6 className='text-white  font-bold pb-5'>Product</h6>
                            <p><a href="#" className='text-white text-sm'>Hello</a></p>
                            <p><a href="#" className='text-white text-sm'>Story</a></p>
                            <p><a href="#" className='text-white text-sm'>Pricing</a></p>
                            <p><a href="#" className='text-white text-sm'>Applications</a></p>
                        </div>
                        <div className="col-span-3">
                            <h6 className='text-white  font-bold pb-5'>Resources</h6>
                            <p><a href="#" className='text-white  text-sm'>New Account</a></p>
                            <p><a href="#" className='text-white  text-sm'>Log in</a></p>
                            <p><a href="#" className='text-white  text-sm'>Testrmonials</a></p>
                            <p><a href="#" className='text-white  text-sm'>Contact</a></p>
                        ...
                        <div className="col-span-3">
                            ...
                            <h6 className='text-white  font-bold '>Subscribe</h6>
                                <form>
                                    <div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white p-2 dark:bg-neutral-900">
                                        <div class="w-full">
                                            <label for="hero-input" class="sr-only">Subscribe</label>
                                            <input type="text" id="hero-input" name="hero-input" class="py-1 px-4 block w-full border-transparent text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none  " placeholder="Enter Address"/>
                                        </div>
                                        <a class="w-full sm:w-auto whitespace-nowrap p-2 inline-flex justify-center items-center gap-x-2 text-sm font-medium border border-transparent bg-gray-800 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="#">
                                            Send
                                        </a>
                                    </div>
                ...
                <div className=" my-3 bg-gray-900">
                    <div className="py-12 flex justify-center">
                        <p className='text-center text-gray-400'> @ Pstls. 2024 All right reserved.</p>
                    </div>
