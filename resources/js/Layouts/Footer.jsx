...
export default function Footer({ auth }) {
    ...
    return (
        <>
            {/* Footer For Mobile */}
            <footer className='md:hidden grid grid-cols-5 border-t border-gray-200 dark:border-gray-600 text-sm text-gray-800    bg-white dark:bg-gray-700 inset-x-0 bottom-0 fixed pt-2'>
                            ...
                            <div className=" space-y-6">
                                ...
                                <div className="flex space-x-2 items-center">
                                    ...
                                    <a href="https://www.linkedin.com/company/boostcareit" target="_blank">
                                        <svg className="w-6 h-6 text-gray-800  dark:text-gray-400 capitalize " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="">
                                        <svg className="w-6 h-6 text-gray-800  dark:text-gray-400 capitalize " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <div className="space-y-1">
                                {
                                    categories.map((item, index) => {
                                        return <Link href={route('servicepage', { category: item.id })} className='text-gray-800 block dark:text-gray-400 u text-sm'>
                                ...
                                <form>
                                    <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white p-2 dark:bg-slate-800 dark:border rounded border-gray-700">
                                        <div className="w-full">
                                            <label htmlFor="hero-input" className="sr-only capitalize ">Subscribe</label>
                                            <input type="text" id="hero-input" name="hero-input" className="py-1 px-4 block w-full border-transparent dark:border-gray-700 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-800  " placeholder="Enter Address" />
                                        </div>
