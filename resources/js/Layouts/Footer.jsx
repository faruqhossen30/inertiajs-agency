...
export default function Footer({ auth }) {
    return (
        <>
            {/* Footer For Mobile */}
            <footer className='md:hidden grid grid-cols-5 border-t border-gray-200 dark:border-gray-600 text-sm text-black   bg-white dark:bg-gray-700 inset-x-0 bottom-0 fixed pt-2'>
            ...
            <section className="w-full border-t dark:border-t-gray-700 bg-gray-100 dark:bg-slate-900">
                    ...
                    <div className="grid grid-cols-12 py-12">
                        <div className="col-span-4">
                            <div className=" space-y-6">
                                ...
                                <p className='text-sm text-gray-800 leading-7  font-light dark:text-white   '>Boost Care It is here to offer services  just for you!  <br />Our team of skilled professionals is ready  to give <br /> you the best creative design, digital marketing <br /> development,  and more.</p>
                        ...
                        <div className="col-span-3 pl-10">
                            <h6 className='text-black  font-bold dark:text-white  pb-5'>Resources</h6>
                            <p><a href="#" className='text-black dark:text-white  text-sm'>About Us</a></p>
                            <p><a href="#" className='text-black  dark:text-white text-sm'>Contact Us
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white  text-sm'>Our Team
                            </a></p>

                            <p><a href="#" className='text-black dark:text-white  text-sm'>Privacy Policy
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white  text-sm'>Sitemap
                            </a></p>
                            <p><a href="#" className='text-black  dark:text-white text-sm'>FAQs

                            </a></p>
                            <p><a href="#" className='text-black  dark:text-white text-sm'>Disclaimer

                            </a></p>

                            <p><a href="#" className='text-black text-sm dark:text-white'>Terms and Conditions
                            </a></p>
                        </div>
                        <div className="col-span-2">
                            <h6 className='text-black  font-bold dark:text-white pb-5'>Services</h6>
                            <p><a href="#" className='text-black dark:text-white text-sm'>Creative & Design
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>Development</a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>SEO</a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>Content Writing
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>Video & Animation
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>e-Commerce
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>Digital Marketing
                            </a></p>
                            <p><a href="#" className='text-black dark:text-white text-sm'>Business Consultants
                            </a></p>

                        </div>
                        <div className="col-span-3">
                            <div className="space-y-3 ">
                            <h6 className='text-black  font-bold dark:text-white '>Subscribe</h6>
                                <form>
                                    <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white p-2 dark:bg-neutral-900">
                                        <div className="w-full">
                                            ...
                                            <input type="text" id="hero-input" name="hero-input" className="py-1 px-4 block w-full border-transparent dark:border-gray-100 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none  " placeholder="Enter Address"/>
                                        </div>
