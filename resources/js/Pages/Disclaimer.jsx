...
export default function AboutPage({ auth, user, laravelVersion, phpVersion }) {
    ...
    return (
        ...
        <section class="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">General Disclaimer</h2>
            <p>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">External Links Disclaimer</h2>
            <p>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Professional Disclaimer</h2>
            <p>
        ...
        <section class="bg-white p-6 rounded-lg shadow-md mb-6">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">Affiliate Disclaimer</h2>
            <p>
