                        ...
                        <div className="border rounded  dark:border-neutral-600 shadow-md">
                            ...
                            <div className="py-5 flex justify-center">
                                <ul class="flex flex-col px-5 w-full">
                                    <li class="inline-flex items-center gap-x-3.5 py-3 px-4 text-sm font-medium bg-white dark:text-gray-400 border border-gray-200 text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg dark:bg-slate-900 dark:border-neutral-700 ">
