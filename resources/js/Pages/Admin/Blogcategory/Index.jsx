                                ...
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($categories as $category)
                                        <tr className="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            <td
                                                className="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{$categories->firstItem() + $loop->index}}</td>
                                            <td
                                                className="px-3 py-2 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                                category name</td>

                                            {/* <td className="px-3 py-2 whitespace-nowrap text-right text-sm font-medium">
                                                <x-table.action_button route="blogcategory" :id="$category->id"/>
                                            </td> */}
                                        </tr>
                                    @endforeach
