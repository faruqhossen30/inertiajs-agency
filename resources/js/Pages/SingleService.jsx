...
<AppLayout>
    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="flex justify-center items-center">
            ...
            <input type="checkbox" id="hs-basic-with-description" onChange={(e)=> setIsChecked(e.target.checked)}
            ...
            <label
                className="relative min-w-14 text-sm text-gray-500 ms-3 dark:text-neutral-400">
                Annual
                <span className="absolute -top-10 start-auto -end-28">
                    <span className="flex items-center">
                        ...
                        <span
                            className="mt-3 inline-block whitespace-nowrap text-[11px] leading-5 font-semibold tracking-wide uppercase bg-blue-600 text-white rounded-full py-1 px-2.5">Save
                            up to 10%</span>
                    </span>
                </span>
            </label>
