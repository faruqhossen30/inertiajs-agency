...
export default function TeamPage({ auth, user, laravelVersion, phpVersion,teams }) {
        ...
        <AppLayout>
            ...
            <div className="container px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                    <h2 className="text-2xl font-Montserrat font-bold md:text-4xl md:leading-tight text-gray-800 dark:text-gray-400">Our leadership</h2>
                    ...
                    {teams.map((member, index) => {
                        return <div key={index} className="group hover:shadow-md hover:scale-105 hover:transition-all duration-1000 flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
                            <div className="flex items-center gap-x-4 ">
                                <img className="rounded-full w-16 h-16" src={window.location.origin + '/storage/' + member.avatar} alt="Avatar" />
                                <div className="grow">
