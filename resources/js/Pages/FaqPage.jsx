                        ...
                        {faqs.map((item, index) => {
                            return <div key={index} className="col-span-6">
                                <div class="hs-accordion-group ">
                                    <div class="hs-accordion " id={`hs-basic-with-title-and-arrow-stretched-heading-${item.id}`}>
                                        ...
                                        <div id={`hs-basic-with-title-and-arrow-stretched-collapse-${item.id}`} class="hs-accordion-content hs-accordion-active:block  hidden w-full overflow-hidden transition-[height] duration-400" role="region" aria-labelledby={`hs-basic-with-title-and-arrow-stretched-heading-${item.id}`}>
