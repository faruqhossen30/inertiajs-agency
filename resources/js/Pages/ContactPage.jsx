            ...
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div className="max-w-2xl lg:max-w-5xl mx-auto">
                    <div className="text-center">
                        <h1 className="text-3xl font-Montserrat font-bold text-gray-800 sm:text-4xl dark:text-gray-400">
                            Contact us
                        </h1>
                    ...
                    <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                        ...
                        <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-gray-700">
                            <h2 className="mb-8 text-xl font-semibold text-gray-800 dark:text-gray-400">
                                Fill in the form
                            </h2>
                        ...
                        <div className="divide-y divide-gray-200 dark:divide-gray-800">
                            ...
                            <div className="flex gap-x-7 py-6">
                                <svg className="flex-shrink-0 w-6 h-6 mt-1.5   text-red-400" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z" />
                                </svg>
                                <div>
                                    <h3 className="font-semibold text-gray-800 dark:text-gray-400">Contact me by email</h3>
                            ...
                            <div className="flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-800 dark:text-gray-400">Skype</h3>
                            ...
                            <div className=" flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-800 dark:text-gray-400">Calendy Shedule</h3>
                            ...
                            <div className=" flex gap-x-7 py-6">
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-800 dark:text-gray-400">Contact me by WhatsApp</h3>
